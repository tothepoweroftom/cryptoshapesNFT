...
const CONTRACT_ADDRESS = "0x7BbC2457e703aecE17F0FF0836bf8786274240e2";
...
const setupEventListener = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        connectedContract.on("NewCryptoShapeMinted", (from, tokenId) => {
...
const askContractToMintNft = async () => {
  ...
  try {
    ...
    if (ethereum) {
      ...
      let nftTxn = await connectedContract.generateNewImage();
